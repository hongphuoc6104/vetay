...
Write the visual story before the narration: one question, one concrete situation, one actionable result; 18–24 visual beats. Drawings must communicate the situation and outcome when muted. Labels contain 1–4 words, at most two visible. Keep paper, bold ink, teal guidance and gold result accents. No permanent title, caption panel, avatar or classic frame in the body. The approved branded intro/outro are separate reusable segments; read [identity workflow](references/identity.md) before creating a video. Retire stale marks; preserve objects through scene boundaries with shared IDs.
