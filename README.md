...
Cấu trúc mới: [hai kênh và giọng riêng](lab/video-workflow/CHANNELS.md). Nội dung nằm tại channels/science hoặc channels/storytelling trên nhánh tương ứng. Bộ dựng dùng đường dẫn gói, cùng một môi trường local.
